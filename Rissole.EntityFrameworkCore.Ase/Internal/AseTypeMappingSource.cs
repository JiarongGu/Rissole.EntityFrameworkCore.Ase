using Rissole.EntityFrameworkCore.Ase.Internal.TypeMappings;
...
namespace Rissole.EntityFrameworkCore.Ase.Internal
{
    internal class AseTypeMappingSource : RelationalTypeMappingSource
    {
        ...
        private readonly AseCharBooleanTypeMapping _charBoolean
             = new AseCharBooleanTypeMapping();
            ...
            : base(dependencies, relationalDependencies)
        {
            ...
            _storeTypeMappings
                = new Dictionary<string, RelationalTypeMapping>(StringComparer.OrdinalIgnoreCase)
                {
                    ...
                    { "xml", _xml },
                    { "yes no char as boolean", _charBoolean}
                };
        }
